...
function loadDataTable() {
    datatable = $('#tblDatos').DataTable({
        ...
        "ajax": { "url": "/Admin/Color/obtenerTodos" },
        "columns": [
                ...
                "render": function (data) {  //Alt + 96 para estos simbolos
                    return ` 
                        <div class="text-center">
                            <a href="/Admin/Color/Upsert/${data}" class="btn btn-success text-white" style="cursor:pointer">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <a onclick=Delete("/Admin/Color/Delete/${data}") class="btn btn-danger text-white" style="cursor:pointer">
